  ...
  return (
    <PageLayout title="About StuDENT">
      ...
      <p>
        ...
        That's why StuDENT offers 52 completely free tools with no login required and no hidden costs.
      </p>
      
      <h3>What We Offer</h3>
      <ul>
        <li><strong>9 Calculators</strong> - From basic math to GPA calculations</li>
        <li><strong>9 Image Tools</strong> - Resize, crop, compress, and convert images</li>
        <li><strong>11 PDF Tools</strong> - Merge, split, rotate, and manage PDFs</li>
        <li><strong>7 Media Tools</strong> - Audio and video processing</li>
        <li><strong>7 Student Tools</strong> - Notes, to-dos, timers, and planners</li>
        <li><strong>9 AI Tools</strong> - Essay generators, summarizers, and more</li>
      </ul>
...
export function Help() {
  return (
    <PageLayout title="Help Center">
      ...
      <p>
        Welcome to StuDENT! Here's how to make the most of our 52 free tools:
      </p>
      ...
      <p>
        Our 9 calculators cover everything from basic arithmetic to GPA calculations. 
